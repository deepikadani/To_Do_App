       ...
       <div className = "container mt-3">
        <table className = "table">
          ...
          <tbody>
            ...
            <td>
              {task.status == 'active'?<button onClick ={()=>{changeTaskStatus(task,'deactive')}} className = "btn btn-secondary">Deactive </button>:<button onClick ={()=>{changeTaskStatus(task,'active')}} className = "btn btn-seconday">Active</button>}
            </td>
            </tr>})}
          </tbody>
        </table>
